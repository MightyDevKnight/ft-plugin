...
<Meta title="Components/Actions/Button" component="sux-button" argTypes={extractArgTypes('sux-button')} />
...
export const Default = args => {
  return html`
    <div style="padding: 10%; display: flex; justify-content: center; gap:16px;">
      ...
      >
        <sux-icon name="archive-fill" slot="prefix"></sux-icon>
        Button CTA
        <sux-icon name="caret-down-fill" slot="suffix"></sux-icon>
      </sux-button>
      <sux-button
        .label="${args.label}"
        .name="${args.name}"
...
<Canvas>
  <Story name="CTA">{CTAButton.bind()}</Story>
</Canvas>
...
<Canvas>
  <Story name="Primary">{PrimaryButton.bind()}</Story>
</Canvas>
...
<Canvas>
  <Story name="Secondary">{SecondaryButton.bind()}</Story>
</Canvas>
...
<Canvas>
  <Story name="Negative">{NegativeButton.bind()}</Story>
</Canvas>
...
<Canvas>
  <Story name="Size">{ButtonSizes.bind()}</Story>
</Canvas>
...
<Canvas>{/* <Story name="Quiet">{QuietButton.bind()}</Story> */}</Canvas>
...
<Canvas>
  <Story name="Disabled">{DisabledButton.bind()}</Story>
</Canvas>
