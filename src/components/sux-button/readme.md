...
| `name`      | `name`       | The name attribute to apply to the button                                           | `string`                                          | `'button-'`      |
| `quiet`     | `quiet`      | Is quiet makes the button appear with least prominence.                             | `boolean`                                         | `false`          |
| `size`      | `size`       | specify the size of the button, defaults to m                                       | `"l" \| "m" \| "s" \| "xl"`                       | `'m'`            |
| `type`      | `type`       | The type attribute to apply to the button                                           | `string`                                          | `undefined`      |
| `variant`   | `variant`    | specify the appearance style of the button, defaults to solid.                      | `"cta" \| "negative" \| "primary" \| "secondary"` | `'cta'`          |
