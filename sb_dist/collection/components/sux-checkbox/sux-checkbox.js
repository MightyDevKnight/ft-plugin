      ...
      h("div", { class: "sux-form-field" },
        h("div", { class: {
          ...
          h("label", { htmlFor: checkboxId },
            h("span", { class: "sux-checkbox--box" },
              this.checked && (h("span", { class: "sux-checkbox--icon" },
              ...
              !this.checked && this.indeterminate && (h("span", { class: "sux-checkbox--icon" },
                h("svg", { viewBox: "0 0 16 16" },
                  h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" },
                    h("g", { stroke: "currentColor", "stroke-width": "2" },
                      h("g", { transform: "translate(2.285714, 6.857143)" },
                        h("path", { d: "M10.2857143,1.14285714 L1.14285714,1.14285714" })))))))),
            h("span", { id: this.label, class: "sux-checkbox-label" },
              h("slot", null)))))));
  }
