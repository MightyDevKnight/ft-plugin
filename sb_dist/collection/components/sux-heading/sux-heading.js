...
export class SuxHeading {
  ...
  render() {
    ...
    return (h(Tag, { class: {
        ...
        'sux-heading--display-1': size === "display-1",
        'sux-heading--display-2': size === "display-2",
        'sux-heading--display-3': size === "display-3",
        'sux-heading--display-4': size === "display-4",
  ...
  static get properties() { return {
    "size": {
      ...
      "complexType": {
        ...
        "resolved": "\"display-1\" | \"display-2\" | \"display-3\" | \"display-4\" | \"l\" | \"m\" | \"s\" | \"xl\" | \"xs\" | \"xxl\"",
        "references": {
          "HeadingSize": {
            "location": "import",
            "path": "./interfaces"
