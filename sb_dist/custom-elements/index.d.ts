...
interface SuxActionable extends Components.SuxActionable, HTMLElement {}
export const SuxActionable: {
  prototype: SuxActionable;
  new (): SuxActionable;
};

interface SuxAvatar extends Components.SuxAvatar, HTMLElement {}
export const SuxAvatar: {
  prototype: SuxAvatar;
  new (): SuxAvatar;
};
...
interface SuxIconButton extends Components.SuxIconButton, HTMLElement {}
export const SuxIconButton: {
  prototype: SuxIconButton;
  new (): SuxIconButton;
};

interface SuxIconLibrary extends Components.SuxIconLibrary, HTMLElement {}
export const SuxIconLibrary: {
  prototype: SuxIconLibrary;
  new (): SuxIconLibrary;
};

interface SuxLink extends Components.SuxLink, HTMLElement {}
export const SuxLink: {
  prototype: SuxLink;
  new (): SuxLink;
};
...
interface SuxResponsiveMedia extends Components.SuxResponsiveMedia, HTMLElement {}
export const SuxResponsiveMedia: {
  prototype: SuxResponsiveMedia;
  new (): SuxResponsiveMedia;
};
